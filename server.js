...
var adalConfig = {
    ...
    'redirectUri': 'http://ff5c923e.ngrok.io/api/oauthcallback', // This URL will be used for the Azure AD Application to send the authorization code.
...
bot.dialog('/', [
    ...
    (session) => {
        ...
        if (keywords) {
            ...
            if (keywords === "reset") {
            ...
            else if (keywords === "sitecollections") {
             ...
             else if (keywords === "user") {

                session.beginDialog('/GetUserProfiles');
...
bot.dialog('/SearchKeyword', [
    function (session) {
        builder.Prompts.text(session, 'Enter the keyword for search');
    },
